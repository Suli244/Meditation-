...
import 'package:meditation/features/practice/presentation/widgets/universal_prefs.dart';
...
class __GritViewItemState extends State<_GritViewItem> {
  ...
  void initLike() async {
    like = await UniversalPrefs.readData(
          'practice_like${widget.index}',
        ) ??
        false;
  }
                      ...
                      child: AnimatedContainer(
                        ...
                        child: GestureDetector(
                          ...
                          child: Icon(
                            MyFlutterApp.vector,
                            size: 15,
                            color: like ? Colors.red : AppColors.colorAADC46,
                          ),
                        ),
                      ),
                    ),
